...
budget_data_csv = os.path.join(dirname, "budget_data.csv")
...
output_file = os.path.join(dirname, "PyBank.txt")
...
with open(output_file, "w") as Analysis:
    #Analysis.writelines(['Financial Analysis', '___________________', 'Total Months'])
    Analysis.write('\n'.join(lines))